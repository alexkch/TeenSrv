class User < ApplicationRecord
  ...
  has_many :payment
  has_many :reference_users, class_name: 'Endorsement', foreign_key: 'reference_user_id'
  has_many :endorsed_users, class_name: 'Endorsement', foreign_key: 'endorsed_user_id'	
