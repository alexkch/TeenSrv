...
%w( scroll bootstrap.min jquery sidebar profilemenu stripe_connect myjobs modal_endorse ).each do |filename|
...
%w( index global sidebar forms search myjobs modal_endorse ).each do |filename|
